...
const messages: Messages = {
  ja: {
    ...
    saveReading: "保存する",
    sameAsUsual: "いつも通り",
    sameAsUsualLabel: "いつも通り記録",
    notFeelingWell: "体調が良くない",
    notFeelingWellLabel: "体調に注意",
    noteAddButton: "メモを追加",
    noteTitleNote: "メモを追加",
    noteTitleSame: "メモを追加（任意）",
    noteTitleNotWell: "体調メモを追加",
    noteSubtitle: "タグやひとことを入れると、あとで見返しやすくなります。",
    notePlaceholder: "例: 頭痛, 水分不足, 睡眠4h など",
    noteCancel: "キャンセル",
    noteSave: "保存する",
    notePresetNotWell: "体調が良くないときのメモを残す",
    noteDefault: "メモを追加",
  ...
  en: {
    ...
    sameAsUsualLabel: "Save as usual",
    notFeelingWell: "Not feeling well",
    notFeelingWellLabel: "Flag this entry",
    noteAddButton: "Add a note",
    noteTitleNote: "Add a note",
    noteTitleSame: "Add a note (optional)",
    noteTitleNotWell: "Add context for this entry",
    noteSubtitle: "Tags or a short note make trends easier to spot later.",
    notePlaceholder: "e.g. headache, low sleep, hydration, heavy training",
    noteCancel: "Cancel",
    noteSave: "Save entry",
    notePresetNotWell: "Not feeling well — add a quick note",
    noteDefault: "Note added",
